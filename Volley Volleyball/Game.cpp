...
void Game::init(const char *title, int xpos, int ypos, int width, int height, bool fullscreen)
{
    ...
    player1 = new Player("images/right_look_bird.png", PLAYER_WIDTH, PLAYER_HEIGHT, 0, GAME_HEIGHT-PLAYER_HEIGHT, 'L');
    player2 = new Player("images/left_look_bird.png", PLAYER_WIDTH, PLAYER_HEIGHT, GAME_WIDTH-PLAYER_WIDTH, GAME_HEIGHT-PLAYER_HEIGHT, 'A');
